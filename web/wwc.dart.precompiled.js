...
function dart_precompiled($collectedClasses) {
  ...
  function WorldOffset(m_fOffsetX, m_fOffsetY) {
    this.m_fOffsetX = m_fOffsetX;
    this.m_fOffsetY = m_fOffsetY;
  }
  WorldOffset.builtin$cls = "WorldOffset";
  if (!"name" in WorldOffset)
    WorldOffset.name = "WorldOffset";
  $desc = $collectedClasses.WorldOffset;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WorldOffset.prototype = $desc;
  function Renderable() {
  }
  ...
  function BaseWidget(m_vPos, m_xParent, m_xChildren, m_xClickEventListeners, m_sClickEvent, m_xBackground, m_sBgColor, m_iW, m_iH, m_iRenderLayer, m_bVisible, m_bDraggable, m_bMouseDown, m_sName, m_xOffset, m_bIgnoreVisCheck) {
    this.m_vPos = m_vPos;
    this.m_xParent = m_xParent;
    this.m_xChildren = m_xChildren;
    this.m_xClickEventListeners = m_xClickEventListeners;
    this.m_sClickEvent = m_sClickEvent;
    this.m_xBackground = m_xBackground;
    this.m_sBgColor = m_sBgColor;
    this.m_iW = m_iW;
    this.m_iH = m_iH;
    this.m_iRenderLayer = m_iRenderLayer;
    this.m_bVisible = m_bVisible;
    this.m_bDraggable = m_bDraggable;
    this.m_bMouseDown = m_bMouseDown;
    this.m_sName = m_sName;
    this.m_xOffset = m_xOffset;
    this.m_bIgnoreVisCheck = m_bIgnoreVisCheck;
  }
  BaseWidget.builtin$cls = "BaseWidget";
  if (!"name" in BaseWidget)
    BaseWidget.name = "BaseWidget";
  $desc = $collectedClasses.BaseWidget;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaseWidget.prototype = $desc;
  BaseWidget.prototype.get$m_vPos = function() {
    return this.m_vPos;
  };
  BaseWidget.prototype.get$m_iW = function() {
    return this.m_iW;
  };
  BaseWidget.prototype.get$m_iH = function() {
    return this.m_iH;
  };
  BaseWidget.prototype.get$m_iRenderLayer = function() {
    return this.m_iRenderLayer;
  };
  BaseWidget.prototype.get$m_bVisible = function() {
    return this.m_bVisible;
  };
  BaseWidget.prototype.get$m_sName = function() {
    return this.m_sName;
  };
  BaseWidget.prototype.get$m_xOffset = function() {
    return this.m_xOffset;
  };
  BaseWidget.prototype.get$m_bIgnoreVisCheck = function() {
    return this.m_bIgnoreVisCheck;
  };
  function EditableBaseWidget(m_bSelected, m_xEditSelection, m_vPos, m_xParent, m_xChildren, m_xClickEventListeners, m_sClickEvent, m_xBackground, m_sBgColor, m_iW, m_iH, m_iRenderLayer, m_bVisible, m_bDraggable, m_bMouseDown, m_sName, m_xOffset, m_bIgnoreVisCheck) {
    this.m_bSelected = m_bSelected;
    this.m_xEditSelection = m_xEditSelection;
    this.m_vPos = m_vPos;
    this.m_xParent = m_xParent;
    this.m_xChildren = m_xChildren;
    this.m_xClickEventListeners = m_xClickEventListeners;
  ...
  EditableBaseWidget.builtin$cls = "EditableBaseWidget";
  if (!"name" in EditableBaseWidget)
    EditableBaseWidget.name = "EditableBaseWidget";
  $desc = $collectedClasses.EditableBaseWidget;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditableBaseWidget.prototype = $desc;
  function BtnWidget(m_vPos, m_xParent, m_xChildren, m_xClickEventListeners, m_sClickEvent, m_xBackground, m_sBgColor, m_iW, m_iH, m_iRenderLayer, m_bVisible, m_bDraggable, m_bMouseDown, m_sName, m_xOffset, m_bIgnoreVisCheck) {
    this.m_vPos = m_vPos;
    this.m_xParent = m_xParent;
    this.m_xChildren = m_xChildren;
    this.m_xClickEventListeners = m_xClickEventListeners;
  ...
  BtnWidget.builtin$cls = "BtnWidget";
  if (!"name" in BtnWidget)
    BtnWidget.name = "BtnWidget";
  $desc = $collectedClasses.BtnWidget;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BtnWidget.prototype = $desc;
  function EditWidget(m_sBorderColor, m_sHighlightBorderColor, m_sBackgroundColor, m_sText, m_bFocused, m_xEditCallbacks, m_vPos, m_xParent, m_xChildren, m_xClickEventListeners, m_sClickEvent, m_xBackground, m_sBgColor, m_iW, m_iH, m_iRenderLayer, m_bVisible, m_bDraggable, m_bMouseDown, m_sName, m_xOffset, m_bIgnoreVisCheck) {
    this.m_sBorderColor = m_sBorderColor;
    this.m_sHighlightBorderColor = m_sHighlightBorderColor;
    this.m_sBackgroundColor = m_sBackgroundColor;
    this.m_sText = m_sText;
    this.m_bFocused = m_bFocused;
    this.m_xEditCallbacks = m_xEditCallbacks;
    this.m_vPos = m_vPos;
    this.m_xParent = m_xParent;
    this.m_xChildren = m_xChildren;
    this.m_xClickEventListeners = m_xClickEventListeners;
  ...
  EditWidget.builtin$cls = "EditWidget";
  if (!"name" in EditWidget)
    EditWidget.name = "EditWidget";
  $desc = $collectedClasses.EditWidget;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditWidget.prototype = $desc;
  EditWidget.prototype.set$m_sText = function(v) {
    return this.m_sText = v;
  };
  function EditWidget_onKeyDown_closure(this_0) {
    this.this_0 = this_0;
  }
  EditWidget_onKeyDown_closure.builtin$cls = "EditWidget_onKeyDown_closure";
  if (!"name" in EditWidget_onKeyDown_closure)
    EditWidget_onKeyDown_closure.name = "EditWidget_onKeyDown_closure";
  $desc = $collectedClasses.EditWidget_onKeyDown_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  EditWidget_onKeyDown_closure.prototype = $desc;
  function Game(m_xCanvas, m_xRenderer, m_xUI, m_xTimerHandle, m_iTimerValue, m_xTimerRef) {
    this.m_xCanvas = m_xCanvas;
    this.m_xRenderer = m_xRenderer;
    this.m_xUI = m_xUI;
    this.m_xTimerHandle = m_xTimerHandle;
    this.m_iTimerValue = m_iTimerValue;
    this.m_xTimerRef = m_xTimerRef;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  function Game_Init_closure(this_0) {
    this.this_0 = this_0;
  }
  ...
  function Game_onUIClick_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_onUIClick_closure.builtin$cls = "Game_onUIClick_closure";
  if (!"name" in Game_onUIClick_closure)
    Game_onUIClick_closure.name = "Game_onUIClick_closure";
  $desc = $collectedClasses.Game_onUIClick_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_onUIClick_closure.prototype = $desc;
  function Game_onUIClick__closure(this_1) {
    this.this_1 = this_1;
  }
  Game_onUIClick__closure.builtin$cls = "Game_onUIClick__closure";
  if (!"name" in Game_onUIClick__closure)
    Game_onUIClick__closure.name = "Game_onUIClick__closure";
  $desc = $collectedClasses.Game_onUIClick__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_onUIClick__closure.prototype = $desc;
  function Gfx(m_vPos, m_iW, m_iH, m_iRenderLayer, m_bLoaded, m_bScaled, m_bVisible, m_xImage, m_xOffset, m_bIgnoreVisCheck) {
    this.m_vPos = m_vPos;
    this.m_iW = m_iW;
    this.m_iH = m_iH;
    this.m_iRenderLayer = m_iRenderLayer;
    this.m_bLoaded = m_bLoaded;
    this.m_bScaled = m_bScaled;
    this.m_bVisible = m_bVisible;
    this.m_xImage = m_xImage;
    this.m_xOffset = m_xOffset;
    this.m_bIgnoreVisCheck = m_bIgnoreVisCheck;
  }
  Gfx.builtin$cls = "Gfx";
  if (!"name" in Gfx)
    Gfx.name = "Gfx";
  $desc = $collectedClasses.Gfx;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Gfx.prototype = $desc;
  Gfx.prototype.get$m_vPos = function() {
    return this.m_vPos;
  };
  Gfx.prototype.get$m_iW = function() {
    return this.m_iW;
  };
  Gfx.prototype.get$m_iH = function() {
    return this.m_iH;
  };
  Gfx.prototype.get$m_iRenderLayer = function() {
    return this.m_iRenderLayer;
  };
  Gfx.prototype.get$m_bVisible = function() {
    return this.m_bVisible;
  };
  Gfx.prototype.get$m_xOffset = function() {
    return this.m_xOffset;
  };
  Gfx.prototype.get$m_bIgnoreVisCheck = function() {
    return this.m_bIgnoreVisCheck;
  };
  function Renderer(m_xContext, m_xItems, m_xWorldOffset, m_sBackgroundColor) {
    this.m_xContext = m_xContext;
    this.m_xItems = m_xItems;
    this.m_xWorldOffset = m_xWorldOffset;
    this.m_sBackgroundColor = m_sBackgroundColor;
  }
  ...
  function Renderer_AddItem_closure() {
  }
  Renderer_AddItem_closure.builtin$cls = "Renderer_AddItem_closure";
  if (!"name" in Renderer_AddItem_closure)
    Renderer_AddItem_closure.name = "Renderer_AddItem_closure";
  $desc = $collectedClasses.Renderer_AddItem_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Renderer_AddItem_closure.prototype = $desc;
  function Renderer_Update_closure(p_nDelta_0) {
    this.p_nDelta_0 = p_nDelta_0;
  }
  Renderer_Update_closure.builtin$cls = "Renderer_Update_closure";
  if (!"name" in Renderer_Update_closure)
    Renderer_Update_closure.name = "Renderer_Update_closure";
  $desc = $collectedClasses.Renderer_Update_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Renderer_Update_closure.prototype = $desc;
  function Renderer_Render_closure(this_0) {
    this.this_0 = this_0;
  }
  Renderer_Render_closure.builtin$cls = "Renderer_Render_closure";
  if (!"name" in Renderer_Render_closure)
    Renderer_Render_closure.name = "Renderer_Render_closure";
  $desc = $collectedClasses.Renderer_Render_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Renderer_Render_closure.prototype = $desc;
  function TextWidget(m_sText, m_sTextColor, m_sFont, m_sTextShadow, m_vPos, m_xParent, m_xChildren, m_xClickEventListeners, m_sClickEvent, m_xBackground, m_sBgColor, m_iW, m_iH, m_iRenderLayer, m_bVisible, m_bDraggable, m_bMouseDown, m_sName, m_xOffset, m_bIgnoreVisCheck) {
    this.m_sText = m_sText;
    this.m_sTextColor = m_sTextColor;
    this.m_sFont = m_sFont;
    this.m_sTextShadow = m_sTextShadow;
    this.m_vPos = m_vPos;
    this.m_xParent = m_xParent;
    this.m_xChildren = m_xChildren;
    this.m_xClickEventListeners = m_xClickEventListeners;
  ...
  TextWidget.builtin$cls = "TextWidget";
  if (!"name" in TextWidget)
    TextWidget.name = "TextWidget";
  $desc = $collectedClasses.TextWidget;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TextWidget.prototype = $desc;
  TextWidget.prototype.set$m_sText = function(v) {
    return this.m_sText = v;
  };
  function TextWidget_Render_closure(box_0, this_1, p_xCtx_2, iTextSize_3, x_4) {
    this.box_0 = box_0;
    this.this_1 = this_1;
    this.p_xCtx_2 = p_xCtx_2;
    this.iTextSize_3 = iTextSize_3;
    this.x_4 = x_4;
  }
  TextWidget_Render_closure.builtin$cls = "TextWidget_Render_closure";
  if (!"name" in TextWidget_Render_closure)
    TextWidget_Render_closure.name = "TextWidget_Render_closure";
  $desc = $collectedClasses.TextWidget_Render_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TextWidget_Render_closure.prototype = $desc;
  function UI(m_xChildren, m_xRenderer, m_iID) {
    this.m_xChildren = m_xChildren;
    this.m_xRenderer = m_xRenderer;
    this.m_iID = m_iID;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  UI.prototype = $desc;
  function UI_Unload_closure(this_0) {
    this.this_0 = this_0;
  }
  UI_Unload_closure.builtin$cls = "UI_Unload_closure";
  if (!"name" in UI_Unload_closure)
    UI_Unload_closure.name = "UI_Unload_closure";
  $desc = $collectedClasses.UI_Unload_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UI_Unload_closure.prototype = $desc;
  function UI_onLayoutLoaded_closure(this_0) {
    this.this_0 = this_0;
  }
  UI_onLayoutLoaded_closure.builtin$cls = "UI_onLayoutLoaded_closure";
  if (!"name" in UI_onLayoutLoaded_closure)
    UI_onLayoutLoaded_closure.name = "UI_onLayoutLoaded_closure";
  $desc = $collectedClasses.UI_onLayoutLoaded_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UI_onLayoutLoaded_closure.prototype = $desc;
  function UI_ParseChildren_closure(this_0, p_xParent_1) {
    this.this_0 = this_0;
    this.p_xParent_1 = p_xParent_1;
  }
  UI_ParseChildren_closure.builtin$cls = "UI_ParseChildren_closure";
  if (!"name" in UI_ParseChildren_closure)
    UI_ParseChildren_closure.name = "UI_ParseChildren_closure";
  $desc = $collectedClasses.UI_ParseChildren_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UI_ParseChildren_closure.prototype = $desc;
  function Vec2(m_fX, m_fY) {
    this.m_fX = m_fX;
    this.m_fY = m_fY;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Vec2.prototype = $desc;
  Vec2.prototype.get$m_fX = function() {
    return this.m_fX;
  };
  ...
  CanvasImageSource.builtin$cls = "CanvasImageSource";
  if (!"name" in CanvasImageSource)
    CanvasImageSource.name = "CanvasImageSource";
  $desc = $collectedClasses.CanvasImageSource;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CanvasImageSource.prototype = $desc;
  function WindowBase() {
  }
